...
#define PM_METAL_NET_IMPORT(name) PM_METAL_WASI_IMPORT(PM_METAL_NET_WASI_MODULE, name)
...
extern pm_metal_async_handle_t pm_metal_net_listen(pm_metal_net_sock_h h, uint32_t port)
...
extern uint32_t pm_metal_net_send(pm_metal_net_sock_h h, uint32_t ptr, uint32_t len)
  PM_METAL_NET_IMPORT(pm_metal_net_send);
extern pm_metal_async_handle_t pm_metal_net_recv(pm_metal_net_sock_h h, uint32_t ptr, uint32_t len)
 ...
 */
extern int32_t pm_metal_net_seed_host(uint32_t dest, uint32_t dest_cap)
  PM_METAL_NET_IMPORT(pm_metal_net_seed_host);
extern void pm_metal_net_close(pm_metal_net_sock_h h) PM_METAL_NET_IMPORT(pm_metal_net_close);
...
extern int32_t pm_metal_net_bind(pm_metal_net_sock_h h, uint32_t port)
  PM_METAL_NET_IMPORT(pm_metal_net_bind);
/** UDP sendto (ASCII host / dotted IP). Returns bytes sent, or 0. */
extern uint32_t pm_metal_net_sendto(pm_metal_net_sock_h h, uint32_t ptr, uint32_t len,
                                    const char *host, uint32_t port)
  PM_METAL_NET_IMPORT(pm_metal_net_sendto);
/** Non-blocking recv: bytes, 0 empty, (uint32_t)-1 closed/error. */
extern uint32_t pm_metal_net_try_recv(pm_metal_net_sock_h h, uint32_t ptr, uint32_t len)
  PM_METAL_NET_IMPORT(pm_metal_net_try_recv);
/**
 ...
 */
extern uint32_t pm_metal_net_try_recvfrom(pm_metal_net_sock_h h, uint32_t ptr, uint32_t len,
                                          uint32_t peer_host, uint32_t peer_cap,
                                          uint32_t peer_port_ptr)
  PM_METAL_NET_IMPORT(pm_metal_net_try_recvfrom);
...
uint32_t                pm_metal_net_sendto(pm_metal_net_sock_h h, const void *ptr, uint32_t len,
                                            const char *host, uint32_t port);
...
uint32_t                pm_metal_net_try_recvfrom(pm_metal_net_sock_h h, void *ptr, uint32_t len,
