...
#define PM_METAL_NET_IP_DHCP6_STATELESS 1
#define PM_METAL_NET_IP_DHCP6_STATEFUL  2
 ...
 * Product DNS result string lives on net.h: pm_metal_net_ip_dns_last_ntoa.
 */
...
#endif /* PYMERGETIC_METAL_NET_IP_CFG_H_ */
