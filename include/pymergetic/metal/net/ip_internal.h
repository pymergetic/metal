...
typedef void (*pm_metal_ip_l4_rx_fn)(const uint8_t *ip_pkt, uint32_t ip_len, uint32_t ihl);
...
void pm_metal_ip_arp_cache_put(uint32_t ip_host, const uint8_t mac[6]);
