...
PM_METAL_PY_BIND(g_py_bind_asgi_listen,
...
PM_METAL_PY_BIND(
  g_py_bind_asgi_mount, "pymergetic.metal.net.asgi", "mount", py_asgi_mount_obj, PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_unmount,
                 "pymergetic.metal.net.asgi",
                 "unmount",
                 py_asgi_unmount_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(
  g_py_bind_asgi_close, "pymergetic.metal.net.asgi", "close", py_asgi_close_obj, PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_autoload,
                 "pymergetic.metal.net.asgi",
                 "autoload",
                 py_asgi_autoload_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_app_health,
                 "pymergetic.metal.net.asgi",
                 "app_health",
                 py_asgi_app_health_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_app_static,
                 "pymergetic.metal.net.asgi",
                 "app_static",
                 py_asgi_app_static_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_register_py,
                 "pymergetic.metal.net.asgi",
                 "register_py",
                 py_asgi_register_py_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_reload,
                 "pymergetic.metal.net.asgi",
                 "reload",
                 py_asgi_reload_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_conn_method,
                 "pymergetic.metal.net.asgi",
                 "conn_method",
                 py_asgi_conn_method_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(g_py_bind_asgi_conn_path,
                 "pymergetic.metal.net.asgi",
                 "conn_path",
                 py_asgi_conn_path_obj,
                 PM_METAL_PY_SYNC);
...
PM_METAL_PY_BIND(
  g_py_bind_asgi_reply, "pymergetic.metal.net.asgi", "reply", py_asgi_reply_obj, PM_METAL_PY_SYNC);
