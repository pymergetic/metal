//! pymergetic.metal.drivers.input.virtio — barrel: not optional, this is what makes
//! `pymergetic::metal::drivers::input::virtio` resolve at all (Rust's own `use`/`mod` needs
