...
static FLOOR_ENTRIES: RegModStatic<1, 0> =
    RegModStatic::new([RegEntry::new("pm_metal_dev_random_detect")], []);

extern "C" fn floor_register_symbols(_ctx: *mut c_void) -> i32 {
    publish_entries(
        &FLOOR_ENTRIES.entries,
        &[pm_metal_dev_random_detect as *const c_void],
    )
}

static FLOOR_MOD: RegMod = RegMod {
    name: "pymergetic.metal.dev.random",
    unloadable: false,
    parent: None,
...
#[no_mangle]
pub unsafe extern "C" fn pm_metal_dev_random_mod_load() -> i32 {
