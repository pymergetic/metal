/** @file
  US QWERTY keyboard layout — set-1 make -> ASCII. (impl: common)
**/
#include <stddef.h>

#include <pymergetic/metal/dev/input/keyb_layout.h>

PM_METAL_KEYB_LAYOUT_BEGIN(g_pm_metal_keyb_layout_us) = {
  .name    = "us",
  .aliases = NULL,
  .swap_yz = 0,
  .unshift = {
    ...
    [0x33] = ',',  [0x34] = '.',  [0x35] = '/',  [0x39] = ' ',
    /* Numpad block (0x47-0x53) — always numeric; no NumLock-off cursor-emu. */
