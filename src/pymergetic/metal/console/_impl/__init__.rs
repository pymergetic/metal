...
static FLOOR_ENTRIES: RegModStatic<5, 0> = RegModStatic::new(
    [
        RegEntry::new("pm_metal_console_init0"),
        RegEntry::new("pm_metal_console_ready"),
        RegEntry::new("pm_metal_console_write"),
        RegEntry::new("pm_metal_console_write_styled"),
        RegEntry::new("pm_metal_console_attach"),
    ],
    [],
);
...
extern "C" fn floor_register_symbols(_ctx: *mut c_void) -> i32 {
    publish_entries(
        ...
        &[
            pm_metal_console_init0 as *const c_void,
            pm_metal_console_ready as *const c_void,
            pm_metal_console_write as *const c_void,
            pm_metal_console_write_styled as *const c_void,
            pm_metal_console_attach as *const c_void,
        ],
    )
}

static FLOOR_MOD: RegMod = RegMod {
    name: "pymergetic.metal.console",
    unloadable: false,
    parent: None,
...
#[no_mangle]
pub unsafe extern "C" fn pm_metal_console_mod_load() -> i32 {
