                                   ...
                                   size_t      plain_len)
{
  ...
  crypto_aead_lock((uint8_t *)cipher,
                   (uint8_t *)mac,
                   (const uint8_t *)key,
                   (const uint8_t *)nonce,
                   (const uint8_t *)ad,
...
static int32_t pm_metal_util_crypto_hash_native(
  wasm_exec_env_t exec_env, void *hash, uint32_t hash_len, const void *msg, uint32_t msg_len)
{
  (void)exec_env;
  return (int32_t)pm_metal_util_crypto_hash(hash, (size_t)hash_len, msg, (size_t)msg_len);
}

static int32_t pm_metal_util_crypto_aead_lock_native(wasm_exec_env_t exec_env,
                                                     void           *cipher,
                                                     uint32_t        cipher_cap,
                                                     void           *mac,
                                                     uint32_t        mac_cap,
...
{
  (void)exec_env;
  return (int32_t)pm_metal_util_crypto_aead_lock(cipher,
                                                 (size_t)cipher_cap,
                                                 mac,
                                                 (size_t)mac_cap,
                                                 key,
...
static int32_t pm_metal_util_crypto_aead_unlock_native(wasm_exec_env_t exec_env,
                                                       void           *plain,
                                                       uint32_t        plain_cap,
                                                       const void     *key,
                                                       uint32_t        key_len,
...
{
  (void)exec_env;
  return (int32_t)pm_metal_util_crypto_aead_unlock(plain,
                                                   (size_t)plain_cap,
                                                   key,
                                                   (size_t)key_len,
                                                   nonce,
...
static NativeSymbol g_pm_metal_util_crypto_native_symbols[] = {
  ...
  { "pm_metal_util_crypto_aead_lock",
    (void *)pm_metal_util_crypto_aead_lock_native,
    "(*~*~*~*~*~*~)i",
    NULL },
  { "pm_metal_util_crypto_aead_unlock",
    (void *)pm_metal_util_crypto_aead_unlock_native,
    "(*~*~*~*~*~*~)i",
    NULL },
};
