 ...
 * stdout_fd, stderr_fd) on a new worker thread and hands back its pid in
 * *out_pid. argv/envp are copied internally before this returns — the
 * caller's own arrays (e.g. a tokenized command line living on some
