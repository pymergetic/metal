/*
 * Shell builtin — `focus <id|kernel>`. See shell/commands.h "ops struct"
 ...
 */
#ifndef PYMERGETIC_METAL_SHELL_COMMANDS_FOCUS_H_
#define PYMERGETIC_METAL_SHELL_COMMANDS_FOCUS_H_

#include "pymergetic/metal/shell/shell.h"

/* impl: common — src/common/pymergetic/metal/shell/commands/focus.c */
int pm_metal_shell_cmd_focus(pm_metal_shell_ctx_t *ctx, int argc, char **argv);

#endif /* PYMERGETIC_METAL_SHELL_COMMANDS_FOCUS_H_ */
