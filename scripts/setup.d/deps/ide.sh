...
# Closest-wins fragment for exp2 net (lwIP). Absolute -I so Generic fallback
# (cwd = source dir) still finds <lwip/*.h> and "lwipopts.h".
...
CompileFlags:
  Add:
    ...
    - -m64
    - -mno-red-zone
    - -I${ROOT}/exp2/src/pymergetic/metal/libc
    - -I${ROOT}/exp2/src
    - -I${ROOT}/exp2/src/pymergetic/metal/net/ip
    - -I${ROOT}/exp2/src/pymergetic/metal/net/ip/cfg
