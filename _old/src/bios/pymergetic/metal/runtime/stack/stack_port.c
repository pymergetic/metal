/** @file
  BIOS body for the one EDK2-shaped primitive stack.c needs: switching onto a
  new stack and calling back, via the SetJump/SwitchStack/LongJump shim
  (src/bios/shim/Library/BaseLib.h) — raw asm under the hood, no real UEFI.
**/
