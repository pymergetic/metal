...
static int32_t pm_metal_util_size_format_native(wasm_exec_env_t exec_env,
                                                char           *out,
                                                uint32_t        cap,
                                                uint64_t        bytes)
{
...
static int32_t pm_metal_util_size_format_bytes_native(wasm_exec_env_t exec_env,
                                                      char           *out,
                                                      uint32_t        cap,
                                                      uint64_t        bytes)
{
...
static NativeSymbol g_pm_metal_util_size_native_symbols[] = {
  ...
  { "pm_metal_util_size_format_bytes",
    (void *)pm_metal_util_size_format_bytes_native,
    "(*~I)i",
    NULL },
};
...
{
  if (!wasm_runtime_register_natives(PM_METAL_UTIL_SIZE_WASI_MODULE,
                                     g_pm_metal_util_size_native_symbols,
