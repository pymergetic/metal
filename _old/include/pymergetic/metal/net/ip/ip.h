...
extern pm_metal_async_handle_t pm_metal_net_ip_recv(pm_metal_net_ip_sock_h h,
                                                    uint32_t               ptr,
                                                    uint32_t               len)
...
extern void pm_metal_net_ip_close(pm_metal_net_ip_sock_h h)
  PM_METAL_NET_IP_IMPORT(pm_metal_net_ip_close);
...
extern uint32_t pm_metal_net_ip_sendto(
  pm_metal_net_ip_sock_h h, uint32_t ptr, uint32_t len, const char *host, uint32_t port)
 ...
 */
extern uint32_t pm_metal_net_ip_try_recvfrom(pm_metal_net_ip_sock_h h,
                                             uint32_t               ptr,
                                             uint32_t               len,
                                             uint32_t               peer_host,
                                             uint32_t               peer_cap,
