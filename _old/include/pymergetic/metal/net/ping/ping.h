...
#define PM_METAL_NET_PING_IMPORT(name) PM_METAL_WASI_IMPORT(PM_METAL_NET_PING_WASI_MODULE, name)

extern pm_metal_async_handle_t pm_metal_net_ping(const char *host, uint32_t timeout_ms)
