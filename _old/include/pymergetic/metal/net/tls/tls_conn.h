 ...
 * all wire-pumped through pm_metal_net_ip_recv), pulled out here as a small
 ...
 *
 * impl: common — src/pymergetic/metal/net/tls/tls_conn.c
 */
#ifndef PYMERGETIC_METAL_NET_TLS_CONN_H_
#define PYMERGETIC_METAL_NET_TLS_CONN_H_
...
typedef uint32_t pm_metal_net_tls_conn_h;
 ...
 * is bytes read (0 on clean EOF); pm_metal_net_tls_conn_read_buf() then exposes
...
/** Valid only right after a pm_metal_net_tls_conn_read() await completes. */
...
#endif /* PYMERGETIC_METAL_NET_TLS_CONN_H_ */
