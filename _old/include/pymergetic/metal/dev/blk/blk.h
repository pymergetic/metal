...
#define PM_METAL_BLK_IMPORT(name) PM_METAL_WASI_IMPORT(PM_METAL_BLK_WASI_MODULE, name)

extern uint32_t       pm_metal_blk_count(void) PM_METAL_BLK_IMPORT(pm_metal_blk_count);
extern pm_metal_blk_h pm_metal_blk_at(uint32_t index) PM_METAL_BLK_IMPORT(pm_metal_blk_at);
extern int32_t        pm_metal_blk_ready(pm_metal_blk_h h) PM_METAL_BLK_IMPORT(pm_metal_blk_ready);
