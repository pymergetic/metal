...
extern int pm_metal_ui_tab_close(pm_metal_ui_handle_t h) PM_METAL_UI_IMPORT(pm_metal_ui_tab_close);
extern int pm_metal_ui_tab_activate(pm_metal_ui_handle_t h)
  PM_METAL_UI_IMPORT(pm_metal_ui_tab_activate);
extern unsigned             pm_metal_ui_tab_count(void) PM_METAL_UI_IMPORT(pm_metal_ui_tab_count);
extern pm_metal_ui_handle_t pm_metal_ui_tab_active(void) PM_METAL_UI_IMPORT(pm_metal_ui_tab_active);
...
int pm_metal_ui_tab_content_rect(
  pm_metal_ui_handle_t tab, int32_t *ox, int32_t *oy, int32_t *ow, int32_t *oh);
#endif
