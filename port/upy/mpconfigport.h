...
/* Nested pymergetic.metal.* builtins (wasmmod shape). */
...
/* Also -DMICROPY_PY_LWIP=1 from port/lwip.mk */
...
/* modlwip provides socket; optional LAN AbstractNIC still registered for status. */
