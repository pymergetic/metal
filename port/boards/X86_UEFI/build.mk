...
OBJ += $(BUILD)/metal_mem.o $(BUILD)/metal_tlsf.o $(BUILD)/metal_async.o $(BUILD)/metal_meter.o $(BUILD)/metal_process.o $(BUILD)/metal_unboot.o $(BUILD)/metal_smp.o $(BUILD)/metal_ap_tramp.o $(BUILD)/win32_helpers.o $(BUILD)/metal_acpi.o $(BUILD)/metal_asgi.o $(BUILD)/metal_inspect.o $(BUILD)/metal_console.o $(BUILD)/metal_reg_seats.o $(BUILD)/metal_reg_seats_frozen.o $(BUILD)/metal_ssh_seat_test.o $(BUILD)/metal_inspect_seat_test.o $(BUILD)/metal_process_seat_test.o $(BUILD)/metal_microdot_seat_test.o $(BUILD)/metal_smoke_extras.o
...
repl-check: $(BUILD)/esp/EFI/BOOT/BOOTIA32.EFI
...
run: $(BUILD)/esp/EFI/BOOT/BOOTIA32.EFI
	...
	if [ $$ok -eq 1 ]; then echo "X86_UEFI_OK ENGINE=$(ENGINE) LLD=$(LLD_LINK)"; exit 0; fi; \
	echo "X86_UEFI_FAIL ENGINE=$(ENGINE)"; \
