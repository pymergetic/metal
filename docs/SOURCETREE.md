...
| `util/iface` | `include/…/iface.h` | `src/common/…/util/iface.c` — `impl: common` + its own wasi-import bridge; header-pack registry (lz4(ustar) via `util/lz4` + `util/tar`) and the `NativeSymbol` sym table generated by `scripts/gen_iface_syms.py` (see docs/DOC_IFACE_PLAN.md Part II, docs/IFACE.md) |
