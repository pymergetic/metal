...
- [ ] **Native self-register / full stdlib surface** — loose `/mods/py/stdlib`
      now ships every module from the original Easy *and* Needs-glue tiers
